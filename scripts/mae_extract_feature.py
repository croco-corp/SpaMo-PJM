...
def get_parser():
    ...
    parser.add_argument(
        "--model_name", help="ViT model name", default="MCG-NJU/videomae-large"
    )
        ...
        for i in range(num):
            ...
            if ds_name == "Phoenix14T" or ds_name == "CSL-Daily":
                ...
                for image_list in image_list_chunks:
                    videos.append(
                        [Image.open(image).convert("RGB") for image in image_list]
                    )
                ...
                if ds_name == "How2Sign":
                    ...
                    if len(videos) > 0:
                        ...
                        videos = sliding_window_for_list(
                            videos, window_size=16, overlap_size=args.overlap_size
                        )
